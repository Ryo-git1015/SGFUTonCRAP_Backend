package com.nl.sgfut.back.mapper;
...
public class JsonMapper {
	...
	public static String stringify(Object obj, boolean pretty) {
		try {
			return pretty ? SingletonHolder.pretty.writeValueAsString(obj)
	 ...
	 * <li>{@link JsonMapper#stringify(Object)} をラップして {@link #stringify()
	 * MapのJSON文字列化} を提供します。
	 * </ul>
	 * 
	 * @author
	...
	public static class MapContext {
		 ...
		 * 
		 * @param key putするキー
		 * @return 内包する {@link Map<String, Object>} インスタンスに指定した {@code key} で新しい
		 *         {@link Map<String, Object>} を登録し、<br>
		 ...
		 * 
		 * @return {@link #nest(String)} で登録した {@link MapContext} の <b>親</b> にあたる
		 *         {@link MapContext} を返します。<br>
